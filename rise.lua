...
local foldername = "QueenOp Update 1"
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/AnDepZaiHub/AnDepZaiHubBeta/refs/heads/main/Hookfunc.lua"))()    
print("Idle") 
    spawn(function()
    while wait(.1) do
        if _G.AUTOHAKI then 
...
Button.Image = "rbxassetid://112450245207527"
...
--\\ Create Tab
   Tabs = {
    St = Window:AddTab({ Title = "Game-Server",  = "" }),    
	Settings = Window:AddTab({ Title = "Config-Tab",  = "" }),
    Sh = Window:AddTab({ Title = "shop",  = "" }),
    Main = Window:AddTab({ Title = "Farm",  = "" }),
    stack = Window:AddTab({ Title = "Item",  = "" }), 
    other = Window:AddTab({ Title = "Boss",  = "" }), 
    leviathan = Window:AddTab({ Title = "Leviathan",  = "" }),    
    cailon = Window:AddTab({ Title = "Kitsune-Mirage",  = "" }),   
    RC = Window:AddTab({ Title = "V4",  = "" }),
    spl = Window:AddTab({ Title = "Status-Players",  = "" }),   
    raid = Window:AddTab({ Title = "Raid-Fruits",  = "" }),
    Lc = Window:AddTab({ Title = "Teleport Tween",  = "" }),  
    Ms = Window:AddTab({ Title = "Misc",  = "" }),   
}
--\\ End
--\\ Tab Select
Window:SelectTab(1)
